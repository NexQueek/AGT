...
public class Unternehmen {
	...
	public Unternehmen(String uid, String plz, String ort, String name, String mail, String telefon, String mobil,
			String chef, String groesse, String farbe, String typ, String besonderheiten, String infos) {
		this.uid = uid;
		this.plz = plz;
		this.ort = ort;
		this.name = name;
